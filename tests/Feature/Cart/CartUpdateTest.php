...
class CartUpdateTest extends TestCase
{
    ...
    public function test_it_fails_if_product_cannot_found()
    {
    ...
    public function test_requires_quantity_of_one_or_more()
    {
    ...
    public function test_it_updates_the_quantity_of_product()
    {
